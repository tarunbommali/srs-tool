...
import { NON_FUNCTIONAL_REQUIREMENT_DATA } from '../utils/constants';

const NonFunctionalRequirementsList = () => {
  return (
    <div className="container p-8 mt-4">
      <h2 className="text-2xl font-bold mb-4">Non-Functional Requirements</h2>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
        {NON_FUNCTIONAL_REQUIREMENT_DATA.map((item, index) => (
...
export default NonFunctionalRequirementsList;
